...
Try {
	...
	[string]$appName = 'Creative Cloud Self Service - Named License'
	[string]$appVersion = '5.10.0'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		$applicationList = 'CreativeCloud','Creative Cloud'
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		$exitCode = Execute-Process -Path "MsiExec.exe" -Parameters "/x{4F15C3B4-2319-489C-BB2E-E693A0DCAE0A} /q" -WindowStyle "Hidden" -IgnoreExitCodes '1605' -PassThru
		If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }

		## This essentially replaces the functionality of Creative Cloud Packager. It even uses the same xml file as Creative Cloud Packager to perform the uninstall.
		$applicationList = 'Adobe','Creative Cloud'
		ForEach($installedApplication in $applicationList) {
			$installedApplicationList = Get-InstalledApplication -Name $installedApplication
			ForEach($application in $installedApplicationList) {
				$application
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDF0KNlDyFCRI4N
# cgyWezQoq7mSRxseBMCv2HBpXPJf2aCCH8AwggVvMIIEV6ADAgECAhBI/JO0YFWU
...
# gjcCAQsxDjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCBBo00qaldx2dHe
# ibdAqToNRD/0KGD0THgPVHvoFYRgWzANBgkqhkiG9w0BAQEFAASCAYBi6kWbox5t
# SbDN2epgbjXDSApZ4w9TrmYu+yFrECrRUWsh2CE5SB9dpfqsdRHDdYu3hpIantL+
# +ZRcivKGMc/c6du+G3jt68BNj1RWqU0zXLXnQxxZOEhd/tlmJhmPPZ85PyEAHK5Q
# QhZAJv11Wn1s9N8rCSjlaubat/W+6iGUD9imVmwuuJrQmn5/cFWNr7NJ1F+8RCYn
# QdJvepeIYj976IeGLJHxYRASmmuinD3cKIncfOGtTkFOsBlTxlkpuPsVS/gQcqlx
# bCffS0yemoapC/K0JsonmwTUor2HzJanc0h3C207qJgXUyiWoaJKcPlMkpiN4FaR
# s+k73rg86yhyTtoElO0/w4N2eLB+xHEA8IgbEBWfL2Uij/teHkbEWrovC8+gICdG
# zb83of1r1GhXL7+56KJo7HrrGQ/1E9FBf7Xey6LOXamO1hb8hQ4dlYVJf7Lp+G7R
# s/7co4Hlim8qWYQq0S/EzrblR/IdwEtP1qq/tTEVm6kRJwOK1TmC0I2hggNLMIID
...
# KoZIhvcNAQkDMQsGCSqGSIb3DQEHATAcBgkqhkiG9w0BCQUxDxcNMjMwNTEyMjA0
# NDEyWjA/BgkqhkiG9w0BCQQxMgQwIrEoIBtHExKHJdp6MSfI7ALXHfwtsphWHCL8
# Zrwuo/xnGkpMXu9RBiGeb4NEskmEMA0GCSqGSIb3DQEBAQUABIICABeWRc6quPK8
# GT/HpD9oabEQP9Co/R+2PQozPmnPTkbynOcsxubZ9CEDinRAhMMiT5CIr9BgORsj
# fM03tXpPWJca3NIQwCjRBsvFhZzntifIrCz3Vd00CwEHKuJpFAg7ED1treIseNaz
# HQrVDHSo71e4QFS9BCY0zyXvkajm9q5tiiWxVzPAwdoUnqxun3jVwLuENsOnPx/D
# e7aW0iKzCobUU5SzMjo6c4WzJjlOSyMgO3ubSPILm3dbfcPDNQy7XBCknFupJrvF
# rssflHGLvIaKtKTcfvaDljIHxFXzXn8LvcPMi7CRvdP/eee9d2DYqUhxwF7HvioC
# 5RRU4hk3wO95V3yDcBKocVqLMDUUOfxdmsKPZ+0vZ4GM9ambnRcCR8tGFUvzpl51
# DiigVqUsekdaq2ibuhyysxOQKbIm5DyktE8BcFjjg1xaP2pNHkxI+fwAaSNdt2SJ
# NV6qrSdkh4gSfIX9RRQEVzCwJk5OVTfH6o0HJa1XWP16W/HwLZVmgca2wl+RSBsa
# I+kTkvFRGyeRJToT7UXGCBi/hw9TQUnBmNQ9n638V0tQodMv0w3KGCxXeC4puaHD
# 89vt74BJZiQMQq29qtq//AvNzC2kXyMPGtMCz+ls8NcNyCR3Wln+YI1NVwNddPLd
# 2j7bFOrWtScPNIl0s4TrrbPviN6drBD8
